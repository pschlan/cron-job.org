...
class ChronosNode_getJobNotifications_args
{
    ...
    {
        return 'ChronosNode_getJobNotifications_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ChronosNode_getJobNotifications_args');
