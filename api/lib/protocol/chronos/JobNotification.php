...
class JobNotification
{
    ...
    public function __construct($vals = null)
    {
        if (is_array($vals)) {
            ...
            if (isset($vals['onSslCertExpiry'])) {
                $this->onSslCertExpiry = $vals['onSslCertExpiry'];
            }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 5:
                    if ($ftype == TType::BOOL) {
                        $xfer += $input->readBool($this->onSslCertExpiry);
                    } else {
                        $xfer += $input->skip($ftype);
                    }
                    break;
                case 6:
                    if ($ftype == TType::I32) {
                        $xfer += $input->readI32($this->onSslCertExpirySeconds);
                    } else {
                        $xfer += $input->skip($ftype);
                    }
                    break;
    ...
    public function write($output)
    {
        ...
        if ($this->onSslCertExpiry !== null) {
            $xfer += $output->writeFieldBegin('onSslCertExpiry', TType::BOOL, 5);
            $xfer += $output->writeBool($this->onSslCertExpiry);
            $xfer += $output->writeFieldEnd();
        }
