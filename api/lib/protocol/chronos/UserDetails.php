...
class UserDetails
{
     ...
     * @var bool
     */
    public $suppressNotifications = null;
    ...
    public function __construct($vals = null)
    {
        if (is_array($vals)) {
            ...
            if (isset($vals['suppressNotifications'])) {
                $this->suppressNotifications = $vals['suppressNotifications'];
            }
        }
    }
    ...
    public function read($input)
    {
        ...
        while (true) {
            ...
            switch ($fid) {
                ...
                case 6:
                    if ($ftype == TType::BOOL) {
                        $xfer += $input->readBool($this->suppressNotifications);
                    } else {
                        $xfer += $input->skip($ftype);
                    }
                    break;
    ...
    public function write($output)
    {
        ...
        if ($this->suppressNotifications !== null) {
            $xfer += $output->writeFieldBegin('suppressNotifications', TType::BOOL, 6);
            $xfer += $output->writeBool($this->suppressNotifications);
            $xfer += $output->writeFieldEnd();
        }
