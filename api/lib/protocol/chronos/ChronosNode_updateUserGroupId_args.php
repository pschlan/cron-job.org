...
class ChronosNode_updateUserGroupId_args
{
    ...
    {
        return 'ChronosNode_updateUserGroupId_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ChronosNode_updateUserGroupId_args');
        if ($this->userId !== null) {
        ...
        if ($this->userGroupId !== null) {
            $xfer += $output->writeFieldBegin('userGroupId', TType::I64, 2);
