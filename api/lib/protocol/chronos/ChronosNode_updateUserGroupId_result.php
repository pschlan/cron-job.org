...
class ChronosNode_updateUserGroupId_result
{
    ...
    {
        return 'ChronosNode_updateUserGroupId_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ChronosNode_updateUserGroupId_result');
        if ($this->ie !== null) {
