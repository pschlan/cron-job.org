...
class ChronosNode_getUserInfoForAllUser_result
{
    ...
    {
        return 'ChronosNode_getUserInfoForAllUser_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ChronosNode_getUserInfoForAllUser_result');
