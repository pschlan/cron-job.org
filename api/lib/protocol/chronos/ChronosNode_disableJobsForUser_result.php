...
class ChronosNode_disableJobsForUser_result
{
    ...
    {
        return 'ChronosNode_disableJobsForUser_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ChronosNode_disableJobsForUser_result');
        if ($this->ie !== null) {
