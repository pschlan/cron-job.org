...
class ChronosNodeClient implements \chronos\ChronosNodeIf
{
    ...
    public function getUserScheduleLoad($userId)
    {
        $this->send_getUserScheduleLoad($userId);
        return $this->recv_getUserScheduleLoad();
    }

    public function send_getUserScheduleLoad($userId)
    {
        $args = new \chronos\ChronosNode_getUserScheduleLoad_args();
        $args->userId = $userId;
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
            ...
            $this->output_->writeMessageBegin('getUserScheduleLoad', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_getUserScheduleLoad()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\chronos\ChronosNode_getUserScheduleLoad_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \chronos\ChronosNode_getUserScheduleLoad_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("getUserScheduleLoad failed: unknown result");
    }

    public function getUserInfoForAllUsers()
    {
        $this->send_getUserInfoForAllUsers();
        return $this->recv_getUserInfoForAllUsers();
    }

    public function send_getUserInfoForAllUsers()
    {
        $args = new \chronos\ChronosNode_getUserInfoForAllUsers_args();
        $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
        if ($bin_accel) {
            thrift_protocol_write_binary(
                $this->output_,
            ...
            $this->output_->writeMessageBegin('getUserInfoForAllUsers', TMessageType::CALL, $this->seqid_);
            $args->write($this->output_);
            $this->output_->writeMessageEnd();
            $this->output_->getTransport()->flush();
        }
    ...
    public function recv_getUserInfoForAllUsers()
    {
        $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\chronos\ChronosNode_getUserInfoForAllUsers_result',
                $this->input_->isStrictRead()
            );
        } else {
            $rseqid = 0;
            ...
            $result = new \chronos\ChronosNode_getUserInfoForAllUsers_result();
            $result->read($this->input_);
            $this->input_->readMessageEnd();
        }
        if ($result->success !== null) {
        ...
        throw new \Exception("getUserInfoForAllUsers failed: unknown result");
    }
