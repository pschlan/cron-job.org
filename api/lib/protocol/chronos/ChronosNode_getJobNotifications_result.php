...
class ChronosNode_getJobNotifications_result
{
    ...
    {
        return 'ChronosNode_getJobNotifications_result';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ChronosNode_getJobNotifications_result');
