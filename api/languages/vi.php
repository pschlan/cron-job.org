<?php
$lang = [
  'changeEmail.footer' => 'Bạn nhận được email này vì ai đó đã cố gắng kết nối tài khoản với địa chỉ email của bạn. Trong trường hợp bạn không yêu cầu, vui lòng bỏ qua và xóa email này.',
